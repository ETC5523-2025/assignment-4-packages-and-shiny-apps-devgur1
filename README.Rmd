...
**bushfiredataexplorer** is an R package that provides Australian bushfire data and an interactive Shiny dashboard for visualising fire-risk trends.  
It was created for *ETC5523: Communicating with Data* at Monash University.

## Installation

We can install the development version of **bushfiredataexplorer** from  
[GitHub](https://github.com/ETC5523-2025/assignment-4-packages-and-shiny-apps-devgur1) with:
...
```{r example-plot, echo=TRUE, message=FALSE, warning=FALSE}
library(bushfiredataexplorer)
data("a2_bushfire")
...
```
The plot shows long-term changes in Fire Weather Index (FWI),
a measure of bushfire danger influenced by temperature, humidity, and wind speed.
